...
{
    public GameObject win, lose, ground, scoreboard; //пустые объекты дл€ отображени€ элементов или скрыти€
    public Rigidbody rigidbody;
    private Vector3 moveVector;
    public float force;

    public float defTime = 0;
    public Text textdefTime, wintext, losetext, record; //текстовые пол€ дл€ данных (рекорда)
    void Start()
    {
